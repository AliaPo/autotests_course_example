...
def letter_stat(our_str):
    """
    Функция принимает на вход строку (our_str) и возвращает словарь (letters_dict),
    где ключ - буква строки, а значение - количество повторений этой буквы в строке

    :param our_str: На вход подается строка
    :return: Возвращается словарь с ключом-буквой и значением-количеством повторений буквы
    """
    letters_dict = {}
