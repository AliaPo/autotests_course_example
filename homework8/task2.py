...
class Trigon:
    ...
    def __init__(self, *sides):
        """
        Происходит инициализация экземпляров класса Trigon
        :param sides: N-количество атрибутов
        """
        self.sides = sides
        ...
        if (self.sides[0] > self.sides[1] + self.sides[2]) or \
                (self.sides[1] > self.sides[0] + self.sides[2]) or \
